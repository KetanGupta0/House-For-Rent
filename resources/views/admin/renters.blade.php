    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">House For Rent Renters List</h5>
...
<div class="modal fade" id="renterDetalsModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="renterDetalsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="renterDetalsModalLabel">Modal title</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container mt-5">
                    <div class="row" id="renterDetalsModalBody">
...
<script>
    $(document).ready(function() {
        ...
        function fetchrenterList() {
            $.ajax({
                url: "{{ url('admin/fetch-renters') }}",
                type: "GET",
                async: false,
        ...
        $(document).on('click','.view',function(){
            ...
            $.post("{{url('admin/fetch-user-info')}}",{id:id},function(res){
                $('#renterDetalsModalBody').html(`
                    <div class="col-md-4">
                        <div class="card">
