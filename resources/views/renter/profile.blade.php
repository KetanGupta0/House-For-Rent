...
<head>
    ...
    <title>House For Rent|Profile</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('renter-bookings') }}">My Houses</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{ url('renter-profile') }}">Profile</a>
                    </li>
                    <li class="nav-item">
        ...
        $(document).ready(function() {
            ...
            function loadProfileData() {
                ...
                $.post("{{ url('get-user-profile-info') }}", {
                    ...
                    // Set profile picture
                    $('#profile-pic').html(
                        `<img class="border" src="{{ asset('public/img/profile-pic/${res.image}') }}" width="150px" height="200px"><h2>{{ Session::get('username') }}</h2>`
                    );
